            ...
            <form method="POST" action="{{ route('owner.shops.update', ['shop' => $shop->id]) }}"
              ...
              <div class="p-2 w-full">
                <div class="relative">
                  ...
                  <input type="name" id="name" name="name" value="{{ $shop->name }}" required
              ...
              <div class="p-2 w-full">
                <div class="relative">
                  ...
                  <textarea id="infomation" name="infomation" value="" required rows="10"
                    class="resize-none w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $shop->infomation }}</textarea>
