            ...
            <div>
              ...
              <div class="flex justify-around items-center">
                <span class="title-font font-medium text-2xl text-gray-900">{{ number_format($product->price) }}<span
                    class="text-sm text-gray-400 ml-1">円(税込み)</span></span>
                ...
                <button
                  class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">カートに追加</button>
              </div>
            </div>
          </div>
        </div>
