          ...
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <form method="POST" action="{{ route('admin.owners.update', ['owner' => $owner->id]) }}">
              ...
              <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full">
                  <div class="relative">
                    <div class="leading-7 text-sm text-gray-600">店名</div>
                    <div
                      class="w-full bg-gray-100 bg-opacity-50 rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                      {{ $owner->shop->name }}
                    </div>
                  </div>
                </div>
